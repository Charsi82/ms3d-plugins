...
const char* ms3d_xray_export::GetTitle() { return "S.T.A.L.K.E.R... (*.skl)"; }

static const TCHAR k_filter[] = "X-Ray skeletal motion (*.skl)\0*.skl\0""\0\0";
...
//		return -1;
	...
	while (true)
	{
		if (GetSaveFileName(&ofn) == FALSE)	return -1;
